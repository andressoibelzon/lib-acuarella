...
// import img from '../assets/banner-bg2.jpg'
		...
		<>
			...
			<div className="py-0 py-md-5">
				<div className="container">
					<div className="position-relative rounded-3 overflow-hidden p-3 p-sm-5" id="imgBack">
								...
								<div className="card card-body p-sm-5">
									<div className="d-sm-flex justify-content-between align-items-center mb-2">
										...
										<ul className="list-inline small mb-0">
											...
											<li className="list-inline-item me-0"><i className="fa-solid fa-star text-warning"></i></li>
											<li className="list-inline-item me-0"><i className="fa-solid fa-star text-warning"></i></li>
											<li className="list-inline-item"><i className="fa-solid fa-star text-warning"></i></li>
										</ul>
									</div>
									{/* <!-- Title --> */}
									...
									{/* <!-- Button --> */}
									{/* <a href="#" className="btn btn-primary-soft mb-0 mt-3">Book Now</a> */}
								</div>
							</div>
						</div>
					</div>
